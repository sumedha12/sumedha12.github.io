...
<body>
       <?php  require("/model/database8.php");
  ...
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th class="col-sm-3">INDUSTRY </th>        
        <th class="col-md-3">WEBSITE</th>
      </tr>
    </thead>
     <tbody id="myTable">
          <?php $i = 0;foreach($LongName as $value): ?>
      <tr>
        <td><a  href ="#"><?php global $i; echo($LongName[$i]);?></a></td>
        <td><?php global $i; echo($Industry[$i]);?></td>
        <td><a href="#"><?php global $i; echo($Website[$i]);?></a></td>
      </tr>      
        <?php global $i; $i = $i+1;?> 
 <?php endforeach; ?>
    </tbody>
